...
# Primate Both Haplotypes (subfolder)
Python notebook analyzing the results of running PAV and annotating SVs for MEIs (Transposable Elements) for the primate-specific companion paper. Transposable element call sets can be found with supplemental data in that manuscript. 
